...
async def show_calculation_menu(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        keyboard = [
            ...
            # )],
            [InlineKeyboardButton(
                "2. 🗓️ Создание бронирования",
                web_app=WebAppInfo(url=create_booking_url)
            )],
            [InlineKeyboardButton(
                "3. ✏️ Редактирование бронирования",
          ...
          [InlineKeyboardButton(
              "5. 📢 Рассылка бронирований по чатам",
        ...
        text = (
            ...
            "• *Рассылка бронирований по чатам* - рассылает предложение по брони в ТГ каналы\n\n"
